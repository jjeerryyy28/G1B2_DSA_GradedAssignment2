...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 Question2: 
 You are working in an MNC, which manages the Transactions, where only BST is used as a Data Structure. The company stores all the data of transactions in BST such   
 that the tree is always a complete BST. 
 ...
 ![image](https://user-images.githubusercontent.com/83206495/218295103-e678c3c8-1acc-4c4f-8bf1-b9135b5610e9.png)
